...
improvements from certurium core in the future. Variable renaming would make this process harder without any benefits.
...
To build Certurium Core without wallet, see [*Disable-wallet mode*](/doc/build-unix.md#disable-wallet-mode)
