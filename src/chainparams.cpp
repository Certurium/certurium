...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("0xc486eb56a6678e7a60cd1da7eaf150c9fdc489d149ac22c20c03e2fd1960dcc2");
        ...
        consensus.defaultAssumeValid = uint256S("0xc486eb56a6678e7a60cd1da7eaf150c9fdc489d149ac22c20c03e2fd1960dcc2");
        ...
        genesis = CreateGenesisBlock(1541041438, 4170397801, 0x1d7fffff, 1, 1094595944495494);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xc486eb56a6678e7a60cd1da7eaf150c9fdc489d149ac22c20c03e2fd1960dcc2"));
        assert(genesis.hashMerkleRoot == uint256S("0x59f2027d57fc85d8862ab8fa087afd505f62f8a0856e3507309e832997976e37"));
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1541041438, 4293004155, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1541041438, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
